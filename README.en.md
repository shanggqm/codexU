...
- Leads the overview with a rank emblem and command-radius orbit for the rolling 28-day AI leadership score and Chinese title. Stronger orbit layers label the full measured peak directly, while `person.3.fill` and `clock.fill` show today's agent count and AI hours; the unchanged quota rings sit immediately to its right with matching two-tile summaries beneath both visuals.
