...
- 设置窗口支持中文/英文界面、自动/浅色/深色外观与 Absolutely 暖色主题；该主题中文优先使用 Noto Serif CJK SC，英文、数字和代码按 Fira Code、Fira Mono、Menlo、Consolas、DejaVu Sans Mono 的顺序选择首个可用等宽字体。设置页同时支持状态栏内容与实时预览、主窗口置顶、关闭行为、系统状态和更新检查配置。
